...
def procedure_process(procedure_file):
    ...
    pro_code2idx = dill.load(open("proc_code2index.pkl", "rb"))
    pro_code2idx = {k.replace(".", ""): v for k, v in pro_code2idx.items()}
    pro_pd["ICD9_CODE"] = pro_pd["ICD9_CODE"].apply(lambda x: None if x not in pro_code2idx.keys() else x)
...
if __name__ == "__main__":
    ...
    med_structure_file = "./atc32SMILES.pkl"
    RXCUI2atc4_file = "./RXCUI2atc4.csv"
    cid2atc6_file = "./drug-atc.csv"
    ndc2RXCUI_file = "./ndc2RXCUI.txt"
    ddi_file = "./drug-DDI.csv"
    drugbankinfo = "./drugbank_drugs_info.csv"

    # output files
    ddi_adjacency_file = "./ddi_A_final.pkl"
    ehr_adjacency_file = "./ehr_adj_final.pkl"
    ehr_sequence_file = "./records_final.pkl"
    vocabulary_file = "./voc_final.pkl"
    ddi_mask_H_file = "./ddi_mask_H.pkl"
    atc3toSMILES_file = "./atc3toSMILES.pkl"
